            ...
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    ...
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        Smart banking <br /> for modern life
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                        Transform your financial journey with BtrackiFiS&apos;s cutting-edge features, designed to optimize your banking experience and financial management like never before.
                    </p>
                </div>
            </Container>
                                ...
                                <div className="bento-card w-full flex-row gap-6">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                            Track your spending patterns and get personalized insights to make smarter financial decisions.
                                        </p>
                                    </div>
                                </div>
                            </MagicCard>
                            ...
                            <MagicCard particles={true} className="flex flex-col items-start w-full row-span-1 bg-primary/[0.08]">
                                <div className="bento-card w-full flex-row gap-6">
                                    ...
                                    <div className="flex flex-col mt-auto">
                                        ...
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                            Get intelligent budget recommendations and automated savings plans tailored to your financial goals.
                                        </p>
                                    </div>
                                </div>
                            </MagicCard>
                                    ...
                                    <div className="bento-card w-full relative items-center justify-center">
                                        <div className="w-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                                            <p className="text-base text-muted-foreground text-justify [mask-image:radial-gradient(50%_50%_at_50%_50%,#BAB3FF_0%,rgba(186,179,255,0)_90.69%)]">
                                                We use AI to help you manage your finances smarter. Our tools are designed to optimize your banking experience and financial management like never before. Transform your financial journey with BtrackiFiS&apos;s cutting-edge features. Make informed decisions with personalized insights at your fingertips. Bank smarter with BtrackiFiS. Transform your financial journey with BtrackiFiS&apos;s cutting-edge features. Bank smarter with BtrackiFiS. Transform your financial journey with BtrackiFiS&apos;s cutting-edge features. Bank smarter with BtrackiFiS.
                                            </p>
                                        </div>
                            ...
                            <MagicCard particles={true} className="flex flex-col items-start w-full row-span-1 bg-primary/[0.08]">
                                <div className="bento-card w-full flex-row gap-6">
                                    <div className="flex flex-col mb-auto">
                                        ...
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                            Access your accounts, make payments, and manage investments all in one secure platform.
                                        </p>
                                    </div>
                            ...
                            <MagicCard particles={true} className="flex flex-col items-start w-full bg-primary/[0.08]">
                                <div className="bento-card w-full flex-row gap-6">
                                    ...
                                    <div className="flex flex-col mt-auto">
                                        ...
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                            Receive intelligent alerts about your spending, savings opportunities, and important account updates.
                                        </p>
                                    </div>
                                </div>
                            </MagicCard>
                            <MagicCard particles={true} className="flex flex-col items-start w-full bg-primary/[0.08]">
                                <div className="bento-card w-full flex-row gap-6">
                                    ...
                                    <div className="flex flex-col mt-auto">
                                        ...
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                            Get personalized investment recommendations and market analysis to grow your wealth.
                                        </p>
                                    </div>
                                </div>
                            </MagicCard>
